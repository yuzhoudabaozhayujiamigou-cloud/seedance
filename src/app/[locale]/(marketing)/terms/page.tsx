...
export const metadata = {
    title: "Terms of Service - Seedance",
    description: "Terms of Service for Seedance",
};
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
                {locale === "zh" ? (
                    <>
                        ...
                        <h2>1. 接受条款</h2>
                        <p>
                            欢迎使用 Seedance（"我们"、"我们的"或"本平台"）。访问或使用我们的网站和服务，即表示您同意受这些服务条款（"条款"）的约束。如果您不同意这些条款的任何部分，您就没有权利使用我们的服务。
                        </p>

                        <h2>2. 服务描述</h2>
                        <p>
                            Seedance 是一个 AI 驱动的视频生成平台，允许用户通过文本、图片等输入生成视频内容。我们要努力提供高质量的服务，但不保证生成的视频总是完全符合您的期望。
                        </p>
                        ...
                        <h2>8. 责任限制</h2>
                        <p>
                            在法律允许的最大范围内，Seedance 不对任何间接、偶然、特殊、后果性或惩罚性损害承担责任，包括但不限于利润损失、数据丢失或商誉受损。
                        </p>
                    ...
                    <>
                        ...
                        <p>
                            Welcome to Seedance ("we," "our," or "us"). By accessing or using our website and services, you agree to be bound by these Terms of Service ("Terms"). If you do not agree to any part of these Terms, you do not have permission to access the Service.
                        </p>

                        <h2>2. Description of Service</h2>
                        <p>
                            Seedance is an AI-powered video generation platform that allows users to create video content from text, images, and other inputs. We strive to provide high-quality services but do not guarantee that generated videos will always meet your exact expectations.
                        </p>
                        ...
                        <p>
                            To the maximum extent permitted by law, Seedance shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or goodwill.
                        </p>
